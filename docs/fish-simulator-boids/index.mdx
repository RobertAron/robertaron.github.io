import { BoidsMain } from "./_boids/BoidsMain";

# Fish Simulator (boids)

[Skip to results](#show-me-the-results)
...
<>
  ![Photo of birds a large number of birds flocking. Photo by James
  Wainscoat](./img/birds-flocking.webp)
</>
